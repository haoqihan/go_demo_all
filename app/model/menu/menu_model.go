...
// arModel is a active record design model for table menu operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of menu.
	Table = "menu"
	// Model is the model object of menu.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table menu.
	Columns = struct {
		Id          string //               
        Name        string // 名字          
        Type        string //               
        ...
        ModifiedOn  string // 更新时间      
        DeletedOn   string // 删除时间戳
	}{
		Id:         "id",           
        Name:       "name",         
        Type:       "type",         
