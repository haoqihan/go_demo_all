...
// arModel is a active record design model for table role_menu operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of role_menu.
	Table = "role_menu"
	// Model is the model object of role_menu.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table role_menu.
	Columns = struct {
		Id         string //             
        RoleId     string // 角色ID      
        MenuId     string // 菜单ID      
