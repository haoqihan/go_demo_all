...
// arModel is a active record design model for table user_role operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of user_role.
	Table = "user_role"
	// Model is the model object of user_role.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table user_role.
	Columns = struct {
		Id         string //             
        UserId     string // 用户ID      
        RoleId     string // 角色ID      
